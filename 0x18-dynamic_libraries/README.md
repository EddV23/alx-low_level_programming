...
General
What is a dynamic library, how does it work, how to create one, and how to us it
...
File: libdynamic.so, main.h, 0-main.c
...
Dynamic libraries$ ./1-create_dynamic_lib.sh
Dynamic libraries$ nm -D --defined-only liball.so
0000000000000a90 T _abs
...
0000000000001176 T _strstr
julien@ubuntu:~/0x18. Dynamic libraries$
