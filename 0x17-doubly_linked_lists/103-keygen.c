...
/**
 * main - Entry point of crackme program, that
 *        creates a key based on the provided username
 * @argc: Argument count
...
int main(int __attribute__((__unused__)) argc, char **argv)
{
	...
	char key[7], *user = argv[1];
	int len = strlen(user);
	int i, first = 0, second = 0, third = 1, fourth, fifth = 0, sixth = 0;
